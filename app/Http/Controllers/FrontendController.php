...
$sub_cat = DB::table('sub_categories')->get();
            // return $sub_cat;
 ...
 //return $products->products;
    ...
    public function loginSubmit(Request $request){
        ...
        if(Auth::attempt(['email' => $data['email'], 'password' => $data['password'],'status'=>'active'])){
            ...
            request()->session()->flash('loginerror',__('common.login_invalid'));
    ...
    public function registerSubmit(Request $request){
        ...
        $this->validate($request,[
            ...
            'captcha' => env('ENABLE_CAPTCHA', true) ? 'required|captcha' : 'nullable'
        ]);
    ...
    public function subscribe(Request $request){
        if(! Newsletter::isSubscribed($request->email)){
                ...
                if(Newsletter::lastActionSucceeded()){
                    request()->session()->flash('success', __('common.subscribed_success'));
                    return redirect()->route('home');
                }
                else{
                    Newsletter::getLastError();
                    return back()->with('error', __('common.please_try_again'));
                }
            }
            else{
